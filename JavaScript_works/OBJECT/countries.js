...
//print cunry name ans populaton
for(let country of countries){
console.log("Country name : ",country.name.common,",","Population : ", country.population);
}


//print countery and currency
for(let country of countries){
    console.log("Country name : ",country.name.common,",","Currency : ", country.currencies);
    }
