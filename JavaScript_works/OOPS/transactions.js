...
//function to print transcations
let transaction = (accno)=>{
    if(accno in accounts){
        let transaction_amts = accounts[accno].transactions;
        console.log("Total transactions",transaction_amts);
    }else{
...
let data =accounts[1001].transactions.filter(amt => amt.amount>500)
